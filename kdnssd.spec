...
Version  : 6.10.0
Release  : 98
URL      : https://download.kde.org/stable/frameworks/6.10/kdnssd-6.10.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.10/kdnssd-6.10.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.10/kdnssd-6.10.0.tar.xz.sig
...
%setup -q -n kdnssd-6.10.0
cd %{_builddir}/kdnssd-6.10.0
pushd ..
cp -a kdnssd-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736554598
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DNSSD.so.6.10.0
/usr/lib64/libKF6DNSSD.so.6
/usr/lib64/libKF6DNSSD.so.6.10.0
