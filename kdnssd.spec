...
Version  : 6.0.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.0/kdnssd-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/kdnssd-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kdnssd-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kdnssd-6.0.0
cd %{_builddir}/kdnssd-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711129073
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DNSSD.so.6.0.0
/usr/lib64/libKF6DNSSD.so.6
/usr/lib64/libKF6DNSSD.so.6.0.0
