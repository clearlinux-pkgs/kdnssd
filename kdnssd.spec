...
Source0  : https://download.kde.org/stable/frameworks/5.65/kdnssd-5.65.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.65/kdnssd-5.65.0.tar.xz.sig
...
%prep
%setup -q -n kdnssd-5.65.0
cd %{_builddir}/kdnssd-5.65.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576514949
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdnssd-5.65.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kdnssd/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/kdnssd-5.65.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdnssd/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5DNSSD.so.5.65.0
