...
Source0  : https://download.kde.org/stable/frameworks/5.60/kdnssd-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kdnssd-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563038505
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5DNSSD.so.5.60.0
