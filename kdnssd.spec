...
Source0  : https://download.kde.org/stable/frameworks/6.15/kdnssd-6.15.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.15/kdnssd-6.15.0.tar.xz.sig
...
%setup -q -n kdnssd-6.15.0
cd %{_builddir}/kdnssd-6.15.0
pushd ..
cp -a kdnssd-6.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750106960
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DNSSD.so.6.15.0
/usr/lib64/libKF6DNSSD.so.6
/usr/lib64/libKF6DNSSD.so.6.15.0
