...
Source0  : https://download.kde.org/stable/frameworks/5.54/kdnssd-5.54.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.54/kdnssd-5.54.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1547314670
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5DNSSD.so.5.54.0
